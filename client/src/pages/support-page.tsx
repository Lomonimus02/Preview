...
const faqs = [
  ...
  },
  {
    ...
    answer: "Обратитесь к администратору вашей школы для сброса пароля."
  },
  {
    question: "Как загрузить документы в систему?",
    answer: "Перейдите в раздел 'Документы', нажмите кнопку 'Загрузить' и выберите файл на вашем компьютере."
  },
  {
