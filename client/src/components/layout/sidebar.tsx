...
export function Sidebar({ isOpen }: SidebarProps) {
  ...
  const roleAccess = {
    ...
    [UserRoleEnum.SCHOOL_ADMIN]: ["dashboard", "users", "user-roles", "subgroups", "school-admin-schedule-menu", "homework", "grades", "grading-systems", "analytics", "messages", "notifications", "settings", "support"],
